---
title: BUPA liver disorders \#4
order: 35
---

Bivariate 0036  [Tuebingen pair 0036]

#### **Cause**: drinks
#### **Effect**: sgot (aspartate aminotransferase)

## Descriptive statistics
|       |     cause |   effect |
|:------|----------:|---------:|
| count | 345       | 345      |
| mean  |   3.45507 |  24.6435 |
| std   |   3.33784 |  10.0645 |
| min   |   0       |   5      |
| 25%   |   0.5     |  19      |
| 50%   |   3       |  23      |
...
```{=html}
<iframe width=600 height=500 src="plots/scatter_0036.html"></iframe>
```

## Time series plot (w/ index as timestep)

```{=html}
<iframe width=600 height=500 src="plots/series_0036.html"></iframe>
```
...
+----------+----------------------------------------------+
{{< fa circle-exclamation >}} Units are just a guess. The original data source does not explain the measurement units. See [this article](https://en.wikipedia.org/wiki/Aspartate_transaminase) for reference.
