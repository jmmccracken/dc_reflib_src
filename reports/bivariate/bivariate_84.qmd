---
title: Fine root decomposition data (grasslands)
order: 89
---
...
```{=html}
<iframe width=600 height=500 src="plots/scatter_0090.html"></iframe>
```

## Time series plot (w/ index as timestep)

```{=html}
<iframe width=600 height=500 src="plots/series_0090.html"></iframe>
```
