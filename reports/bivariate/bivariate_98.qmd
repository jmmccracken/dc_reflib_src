---
title: Ball on mystery track \#5
order: 103
---

#### **Cause**: time between first and second barriers
...
```{=html}
<iframe width=600 height=500 src="plots/scatter_0104.html"></iframe>
```

## Time series plot (w/ index as timestep)

```{=html}
<iframe width=600 height=500 src="plots/series_0104.html"></iframe>
```
