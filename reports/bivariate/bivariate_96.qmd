---
title: Ball on mystery track \#3
order: 101
---

#### **Cause**: initial position of ball
#### **Effect**: time between first and second barriers
...
```{=html}
<iframe width=600 height=500 src="plots/scatter_0102.html"></iframe>
```

## Time series plot (w/ index as timestep)

```{=html}
<iframe width=600 height=500 src="plots/series_0102.html"></iframe>
```
